...
public class ManagerHome extends AppCompatActivity {
    ...
    String empCode;
    Button refreshList;
    final String accessLevel = "manager";
    final String approved_by = "nobody";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent listIntent = new Intent(ManagerHome.this, EmployeeListItem.class);
                listIntent.putExtra("empCode", listItem);
                listIntent.putExtra("accessLevel", accessLevel);
                ManagerHome.this.startActivity(listIntent);
            }
        });
...
//                            String name=jsonData.getString("emp_name");
                        ...
                        ArrayAdapter<String> mArrayAdapter = new ArrayAdapter<String>(ManagerHome.this, android.R.layout.simple_expandable_list_item_1, items);
            ...
            queue = RequestSingleton.getInstance(ManagerHome.this).getRequestQueue();
            RequestSingleton.getInstance(ManagerHome.this).addToRequestQueue(ueRequest);
        }
    };
